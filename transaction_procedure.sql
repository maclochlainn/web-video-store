/*
||  Name:    transaction_procedure.sql
||  Author:  Michael McLaughlin
||  Date:    17-May-2016
|| -------------------------------------------------------------------
||  Description:
||    - Creates the add_member and add_contact procedures, which are
||      called along with an anonymous block program from the
||      create_web_video_store.sql script.
|| -------------------------------------------------------------------
||  Instructions:
