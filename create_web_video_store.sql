/*
||  Name:    create_web_video_store.sql
||  Author:  Michael McLaughlin
||  Date:    17-May-2016
|| -------------------------------------------------------------------
||  Description:
||    - Extended web video store model to achieve a higher normal
||      form. It depends on the following other scripts, which you
||      should place inside the same directory:
||       - contact_insert.sql
||       - insert_rental.sql
||       - insert_rental_item.sql
||       - transaction_procedure.sql
||       - update_price_functions.sql
|| -------------------------------------------------------------------
||  Instructions:
...
SPOOL create_web_video_store.txt
...
INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_TYPE','BLU-RAY',NULL,'Blu-ray'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_TYPE','3D BLU-RAY',NULL,'3D Blu-ray'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_TYPE','PLAYSTATION 4',NULL,'PlayStation 4'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_TYPE','XBOX ONE',NULL,'Xbox One'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','ACTION',NULL,'Action'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','ADVENTURE',NULL,'Adventure'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','COMEDY',NULL,'Comedy'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','DRAMA',NULL,'Drama'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','FANTASY',NULL,'Fantasy'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','MUSICAL',NULL,'Musical'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','SCIENCE FICTION',NULL,'Science Fiction'
, 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'ITEM','ITEM_GENRE','DOCUMENTARY',NULL,'Documentary'
, 1, SYSDATE, 1, SYSDATE);
...
INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'RATING_AGENCY','RATING_AGENCY','MPAA','MPAA','Motion Picture Association of America', 1, SYSDATE, 1, SYSDATE);

INSERT INTO common_lookup VALUES
( common_lookup_s1.nextval,'RATING_AGENCY','RATING_AGENCY','ESRB','ESRB','Entertainment Software Rating Board', 1, SYSDATE, 1, SYSDATE);
...
-- ------------------------------------------------------------------
-- Create RATING_AGENCY table and sequence and seed data.
-- ------------------------------------------------------------------
...
BEGIN
  FOR i IN (SELECT null
            FROM   user_tables
            WHERE  table_name = 'RATING_AGENCY') LOOP
    EXECUTE IMMEDIATE 'DROP TABLE rating_agency CASCADE CONSTRAINTS';
  END LOOP;
  FOR i IN (SELECT null
            FROM   user_sequences
            WHERE  sequence_name = 'RATING_AGENCY_S1') LOOP
    EXECUTE IMMEDIATE 'DROP SEQUENCE rating_agency_s1';
  END LOOP;
END;
/
...
, rating                 VARCHAR2(5)   CONSTRAINT nn_rating_agency_1  NOT NULL
, rating_agency          VARCHAR2(4)   CONSTRAINT nn_rating_agency_2  NOT NULL
, rating_agency_name     VARCHAR2(50)  CONSTRAINT nn_rating_agency_3  NOT NULL
, rating_agency_meaning  VARCHAR2(255) CONSTRAINT nn_rating_agency_4  NOT NULL
, created_by             NUMBER        CONSTRAINT nn_rating_agency_5  NOT NULL
, creation_date          DATE          CONSTRAINT nn_rating_agency_6  NOT NULL
, last_updated_by        NUMBER        CONSTRAINT nn_rating_agency_7  NOT NULL
, last_update_date       DATE          CONSTRAINT nn_rating_agency_8  NOT NULL
, CONSTRAINT fk_rating_agency_1 FOREIGN KEY (created_by)
  REFERENCES system_user (system_user_id)
, CONSTRAINT fk_rating_agency_2 FOREIGN KEY (last_updated_by)
  REFERENCES system_user (system_user_id)); 

CREATE SEQUENCE rating_agency_s1 START WITH 1001;

-- ------------------------------------------------------------------
-- Seed RATING_AGENCY data in RATING_AGENCY table.
-- ------------------------------------------------------------------
 
INSERT INTO rating_agency VALUES
( rating_agency_s1.nextval
,'G'
,'MPAA'
,(SELECT   common_lookup_meaning
  FROM     common_lookup
  WHERE    common_lookup_table = 'RATING_AGENCY'
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'MPAA')
...
,(SELECT   common_lookup_meaning
  ...
  WHERE    common_lookup_table = 'RATING_AGENCY'
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'EC - Early Childhood: Contains content that may be suitable for ages 3 and older. Contains no material that parents would find inappropriate.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'E - Everyone: Contains content that may be suitable for ages 6 and older. Titles in this category may contain minimal cartoon, fantasy or mild violence and/or infrequent use of mild language.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'E10+ - Everyone 10+: Contains content that may be suitable for ages 10 and older. Titles in this category may contain more cartoon, fantasy or mild violence, mild language, minimal and/or infrequent blood and/or minimal suggestive themes.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'T - Teen: Contains content that may be suitable for ages 13 and older. Titles in this category may contain violence, suggestive themes, crude humor, minimal blood, simulated gambling, and/or infrequent use of strong language.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'M - Mature: Contains content that may be suitable for ages 17 and older. Titles in this category may contain intense violence, blood and gore, sexual content and/or strong language.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'AO - Adult Only: Contains content that is suitable only for adults. Titles in this category may include prolonged scenes of intense violence and/or graphic sexual content and nudity.'
, 1
, SYSDATE
, 1
, SYSDATE);
...
,(SELECT   common_lookup_meaning
  ...
  AND      common_lookup_column = 'RATING_AGENCY'
  AND      common_lookup_type = 'ESRB')
,'RP - Rating Pending: Product has been submitted to the ESRB and is awaiting final rating (prior to product release).'
, 1
, SYSDATE
, 1
, SYSDATE);
...
, item_genre                  NUMBER        CONSTRAINT nn_item_3  NOT NULL
, item_title                  VARCHAR2(60)  CONSTRAINT nn_item_4  NOT NULL
, item_subtitle               VARCHAR2(60) 
, item_desc                   CLOB          CONSTRAINT nn_item_5  NOT NULL
, item_photo                  BFILE
, item_rating_id              NUMBER        CONSTRAINT nn_item_6  NOT NULL
, release_date           DATE          CONSTRAINT nn_item_8  NOT NULL
, created_by                  NUMBER        CONSTRAINT nn_item_9  NOT NULL
, creation_date               DATE          CONSTRAINT nn_item_10 NOT NULL
, last_updated_by             NUMBER        CONSTRAINT nn_item_11 NOT NULL
, last_update_date            DATE          CONSTRAINT nn_item_12 NOT NULL
, CONSTRAINT fk_item_1                      FOREIGN KEY(item_type)
  REFERENCES common_lookup(common_lookup_id)
, CONSTRAINT fk_item_2                      FOREIGN KEY(item_genre)
  REFERENCES common_lookup(common_lookup_id)
, CONSTRAINT fk_item_3                      FOREIGN KEY(created_by)
  REFERENCES system_user(system_user_id)
, CONSTRAINT fk_item_4                      FOREIGN KEY(last_updated_by)
  REFERENCES system_user(system_user_id));

CREATE SEQUENCE item_s1 START WITH 1001;

-- ------------------------------------------------------------------
-- Create GET_RATING function for ITEM.RATING column.
-- ------------------------------------------------------------------
...
CREATE OR REPLACE
  FUNCTION get_rating
  ( pv_rating         VARCHAR2
  , pv_rating_agency  VARCHAR2 ) RETURN NUMBER IS
...
BEGIN
  ...
  FOR i IN get_rating_id( pv_rating, pv_rating_agency ) LOOP
    return_value := i.rating_agency_id;
    found := TRUE;
  END LOOP;

  -- Raise exception for invalid rating.  
  IF NOT found THEN
    RAISE_APPLICATION_ERROR(-20101,'Rating Value not defined in RATING_AGENCY table.');
  END IF;
...
,(SELECT   common_lookup_id
  FROM     common_lookup
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'COMEDY')
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'ACTION')
,'Casino Royale'
,''
, empty_clob()
, NULL
, get_rating('PG-13','MPAA')
,'13-MAR-2007'
, 3, SYSDATE, 3, SYSDATE);
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'ADVENTURE')
,'Brave Heart'
,''
, empty_clob()
, NULL
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'MUSICAL')
,'Camelot'
,''
, empty_clob()
, NULL
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'FANTASY')
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
  AND      common_lookup_type = 'SCIENCE FICTION')
,'Star Wars - Episode I'
,'The Phantom Menace'
, empty_clob()
, NULL
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_TYPE'
  AND      common_lookup_type = 'XBOX ONE')
,(SELECT   common_lookup_id
  FROM     common_lookup
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
...
,(SELECT   common_lookup_id
  ...
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_TYPE'
  AND      common_lookup_type = 'PLAYSTATION 4')
,(SELECT   common_lookup_id
  FROM     common_lookup
  WHERE    common_lookup_table = 'ITEM'
  AND      common_lookup_column = 'ITEM_GENRE'
...
-- Count the items by their genre.
SELECT   cl.common_lookup_type
,        COUNT(*)
FROM     item i INNER JOIN common_lookup cl
ON       i.item_genre = cl.common_lookup_id
WHERE    cl.common_lookup_type IN ('ACTION'
                                  ,'ADVENTURE'
                                  ,'COMEDY'
                                  ,'DOCUMENTARY'
                                  ,'DRAMA'
                                  ,'FANTASY'
                                  ,'MUSICAL')
GROUP BY cl.common_lookup_type;
...
-- TELEPHONE tables for Oracle 11g.
@@contact_insert.sql
...
EXECUTE contact_insert('INDIVIDUAL','R11-514-39','1111-1111-3333-1111','VISA_CARD','Smith','Brian','Nathan','CUSTOMER','HOME','Spanish Fork','Utah','84606','333 North 2nd East','HOME','011','801','423-1234');
